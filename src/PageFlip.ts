...
export class PageFlip extends EventObject {
     ...
     */
    public flipNext(corner: FlipCorner = FlipCorner.TOP, forceClick: boolean = false): void {
        this.flipController.flipNext(corner, forceClick);
    }
     ...
     * @param {FlipCorner} corner - Active page corner when turning
     */
    public flipPrev(corner: FlipCorner = FlipCorner.TOP, forceClick: boolean = false): void {
        this.flipController.flipPrev(corner, forceClick);
    }
