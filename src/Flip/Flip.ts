...
export class Flip {
     ...
     * @param globalPos - Touch Point Coordinates (relative window)
     */
    public flip(globalPos: Point, forceClick: boolean = false): void {
     ...
     * @param {FlipCorner} corner - Active page corner when turning
     */
    public flipNext(corner: FlipCorner, forceClick: boolean = false): void {
        this.flip({
     ...
     * @param {FlipCorner} corner - Active page corner when turning
     */
    public flipPrev(corner: FlipCorner, forceClick: boolean = false): void {
        this.flip({
            x: 10,
            y: corner === FlipCorner.TOP ? 1 : this.render.getRect().height - 2,
        }, forceClick);
